...
df[outlier_colums[:3] + ["label"]].boxplot(by="label", figsize=(20, 10), layout=(1, 3))
df[outlier_colums[3:] + ["label"]].boxplot(by="label", figsize=(20, 10), layout=(1, 3))
...
df[outlier_colums[:3] + ["label"]].plot.hist(
...
for col in outlier_colums:
    for label in df["label"].unique():
        ...
        # update the colunm in the orignal dataframe
...
# --------------------------------------------------------------
outlier_removed_df.to_pickle("../../data/interim/outlier_removed_chauvenets.pkl")
